...
<head>
    ...
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"SoftwareApplication","name":"Proposta Fácil","applicationCategory":"BusinessApplication","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"BRL"}}</script>
...
<header class="mx-auto flex max-w-6xl items-center justify-between p-6">
    ...
    <nav class="flex gap-4 text-sm"><a href="{{ route('features') }}">Recursos</a><a href="{{ route('pricing') }}">Preços</a><a href="{{ route('terms') }}">Termos</a><a href="{{ route('privacy') }}">Privacidade</a></nav>
</header>
